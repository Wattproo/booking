    ...
    <header>
        <!-- <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <ul class="navbar-nav">
                <a class="navbar-brand" href="#">
                    <img src="logoMada.jpg" alt="Logo" style="width: 50px; border-radius: 50%;">
                </a>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=article">article</a>
                </li>
                <li class="nav-item">
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="index.php?action=hebergement">Hébergement</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=contact">Contact</a>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="index.php?action=logout"><span class="glyphicon glyphicon-log-in"></span>Se deconnecter</a></li>
            </ul>
