...
<head>
    ...
    <title>Les offres chez SUIMANGA HOTEL</title>
...
<body>
    ...
    <i>
            <li>
                <h2>Suimanga-Hotel :</h2>
            </li>
        </i>

        <div class="hotels">
            <div class="hotel-card">
                <img src="../photo/Atsirabe/Suimanga-hotel/130030258.jpg" alt="# " id="Sary">
                <div class="info">
            ...
            <div class="hotel-card">
                <img src="../photo/Atsirabe/Suimanga-hotel/157090833.jpg" alt="#">
                <div class="info">
            ...
            <div class="hotel-card">
                <img src="../photo/Atsirabe/Suimanga-hotel/Suimanga-hotel.jpg" alt="#">
                <div class="info">
