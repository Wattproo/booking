...
<head>
    ...
    <title>les offres chez EXORA BEACH HOTEL</title>
...
<body>
    <section>
        <i>
            <li>
                <h2>Exora Beach Hotel :</h2>
            </li>
        </i>

        <div class="hotels">
            <div class="hotel-card">
                <img src="hotel diego1.jpg" alt="# " id="Sary">
                <div class="info">
                     <ul>
                        <li></li>
                    </ul>
                    ...
                    <p class="price"> <br> Ar 255 000/ NIGHT</p>
                    <a href="index.php?action=reserver" class="button">RESERVER </a>
                </div>  
            </div>

            <div class="hotel-card">
                <img src="hotel diego2.jpg" alt="#">
                <div class="info">
                     <ul>
                        <li></li>
                    </ul>
