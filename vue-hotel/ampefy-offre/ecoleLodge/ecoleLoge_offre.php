...
<head>
    ...
    <title>Les offres chez ECOLE LODGE</title>
    ...
    <i>
        ...
        <div class="hotels">
            <div class="hotel-card">
                <img src="../photo/Ampefy/Ecole Lodge/215447889.jpg" alt="# " id="Sary">
                <div class="info">
                    ...
                    <p class="price"> <br> Ar 405 000/ NIGHT</p>
                    <a href="index.php?action=reserver" class="button">RESERVER </a>
                </div>
            </div>

            <div class="hotel-card">
                <img src="../photo/Ampefy/Ecole Lodge/images.jpg" alt="#">
                <div class="info">
            ...
            <div class="hotel-card">
                <img src="../photo/Ampefy/Ecole Lodge/Sans titre.jpg" alt="#">
                <div class="info">
